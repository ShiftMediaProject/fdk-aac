...
This is a small list of steps in order to build libfdk-aac into a msvc dll and/or lib file.
...
The project configurations support being built with various different windows SDK versions.
  ...
  (libfdk-aac_with_latest_sdk.bat) which can be used to auto detect the newest available SDK 
